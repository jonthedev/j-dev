...
export function useIcons() {
  ...
  const techBrandColorMap: Record<string, string> = {
    ...
    "simple-icons:cursor": "bg-gray-800/15 text-gray-800 dark:bg-white/10 dark:text-white",
    "simple-icons:ollama": "bg-gray-700/15 text-gray-800 dark:text-gray-300",
    "lucide:sparkles": "bg-amber-500/15 text-amber-700 dark:text-amber-400",
    "lucide:terminal": "bg-emerald-500/15 text-emerald-700 dark:text-emerald-400",
    "lucide:panels-top-left": "bg-green-500/15 text-green-700 dark:text-green-400",
