<template>
  <SharedReveal :delay="100 + index * 50">
    <UCard
      class="group border-dashed border-amber-200 dark:border-amber-800/60 bg-amber-50/30 dark:bg-amber-950/20 hover:border-amber-300 dark:hover:border-amber-700/60 transition-all duration-300 hover:shadow-xl transition-shadow h-full"
      :ui="{
    ...
    >
      <template #header>
        <div class="p-4">
          <div class="architecture-placeholder-header aspect-video overflow-hidden rounded-xl border border-amber-200 dark:border-amber-800/60 bg-amber-100/50 dark:bg-amber-900/20 relative flex items-center justify-center">
            <div
