import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, h, inject, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, toRef, mergeProps, getCurrentScope, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/ofetch/dist/node.mjs';
...
import { getContext, executeAsync } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/h3/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/vue-router/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/defu/dist/defu.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/jdk-cis/Desktop/PROJECTS/jdev/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-B83rZfBd.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-WYcu_QhR.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DC3NXBYX.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-7w1AoFto.mjs'));
