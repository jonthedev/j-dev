...
const pageTitle = computed(() =>
  portfolioMode.mode.value === "frontend"
    ? "JDev Online - Senior Full-Stack Engineer | Web Applications | Vue 3 / Nuxt 4 | NestJS | Randstad & UK-Ready"
    : "JDev Online - 100% Data Sovereignty | AI-Augmented Development without Cloud Risk"
)
const pageDescription = computed(() =>
  portfolioMode.mode.value === "frontend"
    ? "Senior Full-Stack Engineer. Vue 3, Nuxt 4, NestJS. Full-stack web applications and end-to-end type safety. Remote-first with on-site availability for Randstad and UK. KVK registered, Outside IR35 compliant."
