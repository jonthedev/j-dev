  ...
  >
    <UContainer>
      <SharedSectionHeader title="Credentials">
        <p>
          Boot.dev foundations, all visible at once. Backend and computer science, verified.
        </p>
      </SharedSectionHeader>

      <ul class="m-0 grid list-none grid-cols-2 gap-4 p-0 md:grid-cols-3 lg:grid-cols-4">
        <li
